...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-screen-2xl flex-row space-x-6 px-24 py-48">
      <div className="w-24 space-y-5 overflow-hidden rounded-3xl bg-light-card">
        ...
        <div className="flex cursor-pointer flex-col items-center justify-center">
          ...
          <p className="text-base font-bold text-light-text">Clima</p>
        </div>
      </div>
      <div className="flex flex-1 flex-col space-y-5">
        <div className="flex h-14 items-center rounded-xl bg-light-card px-6">
          <input
            type="text"
            name="input-field"
            autoComplete="off"
            placeholder="Search for cities"
            className="w-full border-none bg-transparent text-light-text"
            value={value}
        ...
        <div className="h-60 rounded-3xl bg-light-card p-6">
          ...
          <div className="mt-4 flex flex-row space-x-20">
            <div className="flex items-center">
              <svg
                viewBox="0 0 256 512"
                className="mr-4 h-10 w-10 fill-light-label"
              >
