...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-row px-24 py-48 space-x-6 max-w-screen-2xl w-full mx-auto">
      <div className="w-24 bg-light-card rounded-3xl overflow-hidden space-y-5">
        <a href="https://openweathermap.org/" target="_blank">
          <div className="flex relative h-24 rounded-b-3xl overflow-hidden">
            <Image
        ...
        <div className="flex items-center justify-center flex-col cursor-pointer">
          <svg viewBox="0 0 576 512" className="h-10 w-10 fill-light-text">
          ...
          <p className="text-base text-light-text font-bold">Clima</p>
        </div>
      </div>
      <div className="flex-1 space-y-5 flex flex-col">
        <div className="h-14 bg-light-card rounded-xl flex items-center px-6">
          <input
            type="text"
            name="input-field"
            autoComplete="off"
            placeholder="Search for cities"
            className="bg-transparent border-none w-full text-light-text"
            value={value}
        ...
        <div className="h-60 bg-light-card rounded-3xl p-6">
          ...
          <div className="mt-4 flex flex-row space-x-20">
            <div className="flex items-center">
              <svg
                viewBox="0 0 256 512"
                className="h-10 w-10 fill-light-label mr-4"
              >
              ...
              <div>
                <p className="text-lg text-light-label">Sensación real</p>
                {data?.main.feels_like && (
                  <p className="text-3xl text-light-text font-bold">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-lg text-light-label">Viento</p>
                {data?.main.feels_like && (
                  <p className="text-3xl text-light-text font-bold">
